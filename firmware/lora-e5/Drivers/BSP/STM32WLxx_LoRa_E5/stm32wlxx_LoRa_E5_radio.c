/**
  ...
  *          - RF circuitry available on STM32WLXX-LoRa_E5
...
/** @addtogroup STM32WLXX_LoRa_E5_RADIO_LOW_LEVEL
...
/** @addtogroup STM32WLXX_LoRa_E5_RADIO_LOW_LEVEL_Exported_Functions
  * @{
  */
