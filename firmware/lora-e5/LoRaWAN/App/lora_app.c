...
//  BSP_LED_Init(LED_PWR);

//
  APP_LOG(TS_ON, VLEVEL_M, "Initializing Tx, Rx, and Join timers..\r\n");
...
//
  ...
  APP_LOG(TS_ON, VLEVEL_M, "Initializing LoRa Info..\r\n");
  ...
  APP_LOG(TS_ON, VLEVEL_M, "Starting join led timer..\r\n");
  /* USER CODE BEGIN LoRaWAN_Init_2 */
  UTIL_TIMER_Start(&JoinLedTimer);
  /* USER CODE END LoRaWAN_Init_2 */

  APP_LOG(TS_ON, VLEVEL_M, "Start joining..\r\n");
